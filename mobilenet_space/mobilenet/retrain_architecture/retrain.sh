...
python -m torch.distributed.launch --nproc_per_node=1 retrain.py --save='eval_models' --model_id='0 2 0 4 2 3 3 1 0 3 0 0 3 3 5 1 0 4 3 0 2'

python -m torch.distributed.launch --nproc_per_node=1 retrain.py --save='eval_models' --model_id='1 0 0 2 2 1 3 1 0 3 1 4 3 3 5 1 4 5 0 1 3'

python -m torch.distributed.launch --nproc_per_node=1 retrain.py --save='eval_models' --model_id='0 2 0 4 2 3 3 2 2 3 4 2 2 2 5 1 0 4 3 0 2'
